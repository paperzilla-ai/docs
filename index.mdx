...
description: "Official Paperzilla docs portal for projects, feeds, CLI, MCP, agent workflows, and integrations."
keywords: ["research tracking", "paper feed", "email digest", "project", "MCP", "documentation"]
---
