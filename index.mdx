---
title: "Paperzilla docs"
description: "Learn how to create projects, follow research feeds, and receive email digests in Paperzilla."
---
...
<CardGroup cols={2}>
  ...
  <Card title="Email digests" icon="envelope" href="/guides/email-digests">
    Control digest volume and delivery behavior.
  </Card>
  <Card title="RSS and Atom" icon="square-rss" href="/guides/feeds">
    Add secure feed URLs to your feed reader.
  </Card>
  <Card title="Questions and answers" icon="circle-question" href="/answers/index">
