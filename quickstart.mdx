...
PubMed categories are available in Starter, Plus, and Pro. If your current plan does not include PubMed, the source appears locked and its categories are not included in the proposal.
