...
description: "Add Paperzilla as a custom connector in Claude, then let Claude use projects, full-feed search, paper metadata, and markdown from your Paperzilla account."
keywords: ["Paperzilla Claude MCP", "Claude custom connector", "Paperzilla connector", "Claude paper metadata markdown", "feed search"]
---
