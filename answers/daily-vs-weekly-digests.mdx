...
That schedule follows the timezone set in your user profile. If you want the weekly email to arrive in a different local timezone, update the timezone in your profile settings.
