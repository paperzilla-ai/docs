...
description: "Yes. You can connect MCP clients to Paperzilla and access projects, feeds, full-feed search, paper detail, and markdown."
keywords: ["MCP", "Model Context Protocol", "client connection", "feed search"]
---
