...
1. Start from chat on the [homepage](https://paperzilla.ai) or [dashboard](https://paperzilla.ai/digests).
...
Weekly delivery uses the weekday and time you choose in delivery settings, based on the timezone in your user profile.
