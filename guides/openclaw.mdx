...
description: "Install the Paperzilla skill in OpenClaw so your agent can use the pz CLI to list projects, browse feeds, inspect paper metadata, and fetch markdown."
