...
- **View on source**, **AI summary**, and **Share** actions
- **View PDF** when a PDF URL is available

For PubMed papers, **View on source** opens the PubMed record. Some PubMed records do not have a public PDF, so Paperzilla does not show a PDF action for those papers.
