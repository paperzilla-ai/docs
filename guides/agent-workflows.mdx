...
The Paperzilla CLI is published as an [OpenClaw skill on ClawHub](https://clawhub.ai/pors/paperzilla). Install it with `clawhub install paperzilla` to let agents use `pz` commands directly. See the [CLI guide](/guides/cli#openclaw-skill) for details.
