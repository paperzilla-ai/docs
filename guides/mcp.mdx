...
{/* Test A: aria-label only, no text content */}
<div aria-label="Machine-readable version: https://docs.paperzilla.ai/guides/mcp.md | Index: https://docs.paperzilla.ai/llms.txt" role="note" />

{/* Test B: sr-only text content, no aria */}
<div style={{position:'absolute',width:'1px',height:'1px',padding:0,margin:'-1px',overflow:'hidden',clip:'rect(0,0,0,0)',whiteSpace:'nowrap',border:0}}>
  Machine-readable version: https://docs.paperzilla.ai/guides/mcp.md | Index: https://docs.paperzilla.ai/llms.txt
</div>
