...
1. Open your [dashboard](https://paperzilla.ai/digests).
...
| `paper.get` | Get one paper by paper ID or feed item ID | `pz paper <id>` |
| `paper.markdown` | Get paper markdown or queue markdown generation | `pz paper <id> --markdown` |
...
`paper.markdown` always returns a structured result.
