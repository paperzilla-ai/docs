---
title: "CLI"
description: "Use the Paperzilla CLI to read papers, search project feeds, inspect recommendations, and manage projects from your terminal"
keywords: ["CLI", "terminal", "command line", "pz", "paper management", "recommendations", "feed search"]
---
...
The Paperzilla CLI (`pz`) lets you read canonical papers by Paperzilla paper ID, browse or search your curated project feeds, inspect project-specific recommendations, and leave feedback from the terminal. It works for both humans and AI agents. Use `--json` when you want structured output.
