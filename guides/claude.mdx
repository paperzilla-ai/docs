...
description: "Add Paperzilla as a custom connector in Claude and use your projects, full-feed search, paper detail, and markdown in Claude."
keywords: ["Claude", "MCP", "connector", "custom connector", "Cowork", "feed search"]
---
...
<Frame caption="Paperzilla connector tools in Claude">
  <img
    ...
    alt="Claude connector settings showing the Paperzilla tools and the tool permission controls."
  />
</Frame>
